...
var PageServer = /** @class */ (function () {
    function PageServer(port, rootFolder) {
        this.httpServer = http.createServer(function (request, response) {
            ...
            request.on('error', function (err) {
                ...
                var filePath = rootFolder + request.url;
...
var Session = /** @class */ (function () {
    ...
    Object.defineProperty(Session.prototype, "CurrentPlayerCount", {
        get: function () { return this.connectedPlayerIDs.length; },
        enumerable: true,
        configurable: true
    });
    ;
    Session.prototype.addPlayerByID = function (playerID) {
    ...
    Session.prototype.removePlayerByID = function (playerID) {
        if (this.connectedPlayerIDs.indexOf(playerID) <= -1) {
    ...
    Session.prototype.forEachPlayer = function (callback) {
...
;
var http = __importStar(__webpack_require__(/*! http */ "http"));
var ws = __importStar(__webpack_require__(/*! websocket */ "./node_modules/websocket/index.js"));
var SessionServer = /** @class */ (function () {
    function SessionServer(port) {
        this.commands = {};
    ...
    SessionServer.prototype.SetupCommands = function () {
        var _this = this;
        this.commands["createSession"] = function (playerID, jsonMessage) {
            var newSessionID = _this.generateSessionID();
            _this.sessions[newSessionID] = new Session(newSessionID, jsonMessage.mapName);
            if (_this.sessions[newSessionID].addPlayerByID(playerID)) {
            ...
            _this.sendMessageToPlayer(playerID, JSON.stringify({
                "command": "sessionJoin",
                "sessionID": newSessionID,
                "session": _this.sessions[newSessionID].serializeData()
            }));
        };
        this.commands["joinSession"] = function (playerID, jsonMessage) {
            ...
            if (jsonMessage.sessionID == -1) {
                jsonMessage.sessionID = _this.nextSessionID - 1;
            }
            if (!_this.sessions[jsonMessage.sessionID]) {
                console.log("[PageServer] Session " + jsonMessage.sessionID + " (no longer) doesn't exist");
                return { "sessionID": -1 };
            }
            _this.sessions[jsonMessage.sessionID].addPlayerByID(playerID);
            _this.sendMessageToPlayer(playerID, JSON.stringify({
                "command": "sessionJoin",
                "sessionID": jsonMessage.sessionID,
                "session": _this.sessions[jsonMessage.sessionID].serializeData()
            }));
        };
        this.commands["leaveSession"] = function (playerID, jsonMessage) {
            ...
            _this.sessions[jsonMessage.sessionID].removePlayerByID(playerID);
            console.log("[PageServer] Players left in session " + jsonMessage.sessionID + ": " + _this.sessions[jsonMessage.sessionID].CurrentPlayerCount);
            if (!_this.sessions[jsonMessage.sessionID].CurrentPlayerCount) {
                console.log("[PageServer] Session " + jsonMessage.sessionID + " has no players left; discarding it");
                delete _this.sessions[jsonMessage.sessionID];
            }
            _this.sendMessageToPlayer(playerID, "{}");
        };
    };
    SessionServer.prototype.generatePlayerCloseHandler = function (playerID) {
        var _this = this;
        return function (reasonCode, description) {
            _this.removePlayer(playerID);
        };
    };
    SessionServer.prototype.removePlayer = function (playerID) {
    ...
    SessionServer.prototype.handleNewPlayer = function (request) {
        var _this = this;
        var connection = request.accept(undefined, request.origin);
        var playerID = this.generatePlayerID();
        ...
        this.player[playerID].on('message', function (message) {
            if (message.type === 'utf8') {
                try {
                    ...
                    _this.handleMessage(playerID, jsonMessage);
                }
                catch (e) {
    ...
    SessionServer.prototype.generatePlayerID = function () {
        return this.nextPlayerID++;
    };
    SessionServer.prototype.generateSessionID = function () {
        return this.nextSessionID++;
    };
    SessionServer.prototype.handleMessage = function (playerID, jsonMessage) {
    ...
    SessionServer.prototype.sendMessageToPlayer = function (playerID, message) {
    ...
    SessionServer.prototype.updateReplica = function (session) {
        var _this = this;
        session.forEachPlayer((function (playerID) {
            _this.sendMessageToPlayer(playerID, JSON.stringify({ "command": "sessionUpdate", "session": session.serializeData() }));
        }).bind(this));
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var SessionServer_1 = __webpack_require__(/*! SessionServer/SessionServer */ "./src/SessionServer/SessionServer.ts");
var PageServer_1 = __webpack_require__(/*! PageServer/PageServer */ "./src/PageServer/PageServer.ts");
var sessionServer = new SessionServer_1.SessionServer(parseInt(process.env.PORT || "") || 7996);
var webClientServer = new PageServer_1.PageServer(parseInt(process.env.PORT || "") || 7995, "html");
